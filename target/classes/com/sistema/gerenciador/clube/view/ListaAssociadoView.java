 ...
 * @author rian_
 */
public class ListaAssociadoView extends javax.swing.JFrame {
    
    private ListaAssociadoController listaAssociadoController;
    private List<Associado> listaAssociados;
    
    public ListaAssociadoView() {
        initComponents();
        ajustarComponentes();
        
        listaAssociadoController = new ListaAssociadoController();
        pesquisar();
    }

    private void pesquisar(){
        String pesquisa = jTPesquisa.getText();
        listaAssociados = listaAssociadoController.buscarAssociados(pesquisa);
        preencherTabela();
    }
    ...
    private void preencherTabela(){
        ...
        listaAssociados.forEach(ass -> {
            model.addRow(new Object[] { 
                ass.getId(), 
                ass.getNome() != null ? ass.getNome().toUpperCase() : "", 
                ass.getEndereco() != null ? ass.getEndereco().toUpperCase() : "", 
                ass.getTelefone()
            }); 
        });
    }
    ...
    private void jLNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLNovoMouseClicked
        listaAssociadoController.navegarCadastroAssociado(this);
    ...
    private void jLVoltarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLVoltarMouseClicked
        listaAssociadoController.voltar(this);
